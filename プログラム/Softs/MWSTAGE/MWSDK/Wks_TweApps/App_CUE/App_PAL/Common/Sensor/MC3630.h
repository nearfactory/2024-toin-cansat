...
#define MC3630_SAMPLINGDEFAULT	(0x00)
#define MC3630_SAMPLING002HZ	(0x21)
#define MC3630_SAMPLING004HZ	(0x01)
#define MC3630_SAMPLING008HZ	(0x02)
#define MC3630_SAMPLING009HZ	(0x23)
#define MC3630_SAMPLING015HZ	(0x03)
#define MC3630_SAMPLING06HZ		(0x04)
#define MC3630_SAMPLING07HZ		(0x14)
#define MC3630_SAMPLING13HZ		(0x05)
#define MC3630_SAMPLING14HZ		(0x25)
#define MC3630_SAMPLING25HZ		(0x06)
#define MC3630_SAMPLING28HZ		(0x16)
#define MC3630_SAMPLING50HZ		(0x07)
#define MC3630_SAMPLING54HZ		(0x17)
#define MC3630_SAMPLING55HZ		(0x27)
#define MC3630_SAMPLING80HZ		(0x28)
#define MC3630_SAMPLING100HZ	(0x08)
#define MC3630_SAMPLING105HZ	(0x18)
#define MC3630_SAMPLING190HZ	(0x09)
#define MC3630_SAMPLING210HZ	(0x19)
#define MC3630_SAMPLING380HZ	(0x0A)
#define MC3630_SAMPLING400HZ	(0x1A)
#define MC3630_SAMPLING600HZ	(0x1B)
#define MC3630_SAMPLING750HZ	(0x0B)
#define MC3630_SAMPLING1100HZ	(0x0C)
#define MC3630_SAMPLING1300HZ	(0x0F)

#define MC3630_ULTRALOWPOWER_DEFAULT		(0x00)
#define MC3630_ULTRALOWPOWER_SAMPLING004HZ	(0x01)
#define MC3630_ULTRALOWPOWER_SAMPLING008HZ	(0x02)
#define MC3630_ULTRALOWPOWER_SAMPLING015HZ	(0x03)
#define MC3630_ULTRALOWPOWER_SAMPLING06HZ	(0x04)
#define MC3630_ULTRALOWPOWER_SAMPLING13HZ	(0x05)
#define MC3630_ULTRALOWPOWER_SAMPLING25HZ	(0x06)
#define MC3630_ULTRALOWPOWER_SAMPLING50HZ	(0x07)
#define MC3630_ULTRALOWPOWER_SAMPLING100HZ	(0x08)
#define MC3630_ULTRALOWPOWER_SAMPLING190HZ	(0x09)
#define MC3630_ULTRALOWPOWER_SAMPLING380HZ	(0x0A)
#define MC3630_ULTRALOWPOWER_SAMPLING750HZ	(0x0B)
#define MC3630_ULTRALOWPOWER_SAMPLING1100HZ	(0x0C)
#define MC3630_ULTRALOWPOWER_SAMPLING1300HZ	(0x0F)

#define MC3630_LOWPOWER_DEFAULT				(0x10)
#define MC3630_LOWPOWER_SAMPLING004HZ		(0x11)
#define MC3630_LOWPOWER_SAMPLING008HZ		(0x12)
#define MC3630_LOWPOWER_SAMPLING015HZ		(0x13)
#define MC3630_LOWPOWER_SAMPLING07HZ		(0x14)
#define MC3630_LOWPOWER_SAMPLING14HZ		(0x15)
#define MC3630_LOWPOWER_SAMPLING28HZ		(0x16)
#define MC3630_LOWPOWER_SAMPLING54HZ		(0x17)
#define MC3630_LOWPOWER_SAMPLING105HZ		(0x18)
#define MC3630_LOWPOWER_SAMPLING210HZ		(0x19)
#define MC3630_LOWPOWER_SAMPLING400HZ		(0x1A)
#define MC3630_LOWPOWER_SAMPLING600HZ		(0x1B)
#define MC3630_LOWPOWER_SAMPLING750HZ		(0x1F)

#define MC3630_PRECISION_DEFAULT			(0x20)
#define MC3630_PRECISION_SAMPLING002HZ		(0x21)
#define MC3630_PRECISION_SAMPLING004HZ		(0x22)
#define MC3630_PRECISION_SAMPLING009HZ		(0x23)
#define MC3630_PRECISION_SAMPLING07HZ		(0x24)
#define MC3630_PRECISION_SAMPLING14HZ		(0x25)
#define MC3630_PRECISION_SAMPLING28HZ		(0x26)
#define MC3630_PRECISION_SAMPLING55HZ		(0x27)
#define MC3630_PRECISION_SAMPLING80HZ		(0x28)
#define MC3630_PRECISION_SAMPLING100HZ		(0x2F)
...
typedef struct {
	...
	uint32 u32StartTime_ms;	// sampling start time
	uint32 u32EndTime_ms;	// sampling end time
